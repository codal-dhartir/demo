...
(function (root, factory) {
    ...
    var defaults = {
        ...
        // static variable
         d = new Date();
         n = d.getMonth();
        customMonth = ['January','February', 'March','April','May','June','July ','August','September','October','November','December'],
        ...
        DATE_DIS_TPL = '{year}/<span class="m get-month">{month}</span><span class="m monthformat">{node}</span><span class="m yearformat"> {year}</span>',

        ITEM_STYLE = 'style="width:{w}px;height:{h}px;line-height:{h}px"',
        WEEK_ITEM_TPL = '<li ' + ITEM_STYLE + '><span class="week-item-text">{wk}</span></li>',
        DAY_ITEM_TPL = '<li ' + ITEM_STYLE + ' class="{class}" {action}="{date}"><span class="day-item-text">{value}</span></li>',
        MONTH_ITEM_TPL = '<li class="all-month" ' + ITEM_STYLE + ' ' + ITEM_MONTH + '><span class="month-item-text">{m}</span><input type="hidden" class="month_num" value="{month_num}"><input type="hidden" class="month_full" value="{month_full}" ></li>',
        ...
        TEMPLATE = [
            ...
            '<a href="javascript:;" data-calendar-display-date class="calendar-display month">',
            '{yyyy}/<span class="m get-month">{mm}</span><span class="m d">'+customMonth[n]+'</span><span class="m yearformat"> {yyyy}</span>',
            '</a>',
            ...
            '<div class="calendar-hd">',
            '<a href="javascript:;" data-calendar-display-month class="calendar-display year">{yyyy}</a>',
            '<div class="calendar-arrow">',
    ...
    Calendar.prototype = {
        ...
        resize: function () {
            ...
            this.$element.find('.calendar-ct').width(w).height('430px');

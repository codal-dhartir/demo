...
theme.customerTemplates = (function() {
  function initEventListeners() {
    ...
    $('#RecoverPassword').on('click', function(evt) {
      evt.preventDefault();
      $( ".social").hide();
      function hideSocialMediaLinks(){
        console.log('hid');
      	$( ".social").hide();
      }
      setTimeout(hideSocialMediaLinks,3000);
  ...
  function toggleRecoverPasswordForm() {
    ...
    $('.flora_signin_bg_section').toggleClass('flora_passwd_reset_page');
  }
...
// For Adding product to cart from the visualizer
...
window.onload = function(){
  	...
  	var variant_id = getQueryStringValue("variant_id")
    if(variant_id && getQueryStringValue("action") == "add"){
//       console.log("Variant Id: ", variant_id);
      var quantity = parseInt( getQueryStringValue("qty") );
      var property = getQueryStringValue("properties");
      var orderId = getQueryStringValue("order_id");
       var orderImg = getQueryStringValue("variant_image");
...
//       console.log(orderId);
      ...
      window.setTimeout(function () {
        window.location = "https://floracracy.myshopify.com/cart";
      }, 500);
